...
let template = function(userResponse) {
    return html` 
        <div class="Pirates">
            <h1>The Force</h1> 
                <p>The Force is a mystical,  ${userResponse.adjective} power. As Jedi Master
                 ...
                 It doesn't matter how ${userResponse.pluraladjective4} these objects are; it
                 ...
                 As Obi-Wan Kenobi told his student Luke, ${userResponse.noun}-walker: "Your
